 ...
 * @FU_DEVICE_INTERNAL_FLAG_COLDPLUG_MATCH_GUID:	Match GUIDs on device coldplug, which allows multiple plugins to support the same device
 *
...
typedef enum {
	...
	FU_DEVICE_INTERNAL_FLAG_COLDPLUG_MATCH_GUID	= (1llu << 9),	/* Since: 1.5.8 */
	/*< private >*/
